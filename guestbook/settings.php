...
// Website title
$settings['website_title'] = "Salt Official Website";

// Website URL
$settings['website_url'] = 'https://xn--join-e714c.ml/';

// Guestbook title
$settings['gbook_title'] = "My Guestbook";

// Your e-mail address.
$settings['admin_email'] = 'dont fucking email me';

// URL of the gbook.php file.
$settings['gbook_url'] = 'https://xn--join-e714c.ml/guestbook/gbook.php';
